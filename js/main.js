...
/* harmony import */ var _components_stopbg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/stopbg */ "./src/js/components/stopbg.js");
/* harmony import */ var _components_stopbg__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_stopbg__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _components_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/button */ "./src/js/components/button.js");
/* harmony import */ var _components_button__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_button__WEBPACK_IMPORTED_MODULE_4__);
...
let a = document.querySelector('.complect_info_1');
let but1 = document.querySelector('.button_1');
let img1 = document.querySelector('.button_svg_1');
let b = document.querySelector('.complect_info_2');
let but2 = document.querySelector('.button_2');
let img2 = document.querySelector('.button_svg_2');
let c = document.querySelector('.complect_info_3');
let but3 = document.querySelector('.button_3');
let img3 = document.querySelector('.button_svg_3');
but1.addEventListener('click', () => {
  if (b.classList.contains('complects_info_active')) {
    b.classList.remove('transition');
    img2.classList.toggle('rotate_button');
    b.classList.toggle('complects_info_active');
    a.classList.add('transition');
  } else if (c.classList.contains('complects_info_active')) {
    c.classList.remove('transition');
    img3.classList.toggle('rotate_button');
    c.classList.toggle('complects_info_active');
    a.classList.add('transition');
  } else {
    a.classList.remove('transition');
  }
  img1.classList.toggle('rotate_button');
  a.classList.toggle('complects_info_active');
});
but2.addEventListener('click', () => {
  if (a.classList.contains('complects_info_active')) {
    a.classList.remove('transition');
    img1.classList.toggle('rotate_button');
    a.classList.toggle('complects_info_active');
...
but3.addEventListener('click', () => {
  ...
  } else if (b.classList.contains('complects_info_active')) {
    b.classList.remove('transition');
    img2.classList.toggle('rotate_button');
    b.classList.toggle('complects_info_active');
    c.classList.add('transition');
  ...
  return function (e) {
    ...
    function I(e, t) {
      var n = e.collections.sourceLoadHandlers,
        ...
        s = e.props.sources;
      i[t] = document.createElement("img"), F(e, t, y), i[t].src = s[t], i[t].onload = n[t].handleImageLoad, E(e, t), r[t].appendChild(i[t]);
    }
    function T(e, t) {
      var n = e.collections.sourceLoadHandlers,
        o = e.elements,
    ...
    function N(e, t) {
      ...
      var c = a[t],
        l = c.split("?")[1];
      r[t].src = "https://www.youtube.com/embed/".concat(c.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)[2], "?").concat(l || ""), r[t].allowFullscreen = !0, E(e, t), s[t].appendChild(r[t]), n[t].handleYoutubeLoad();
    }
    function z(e, t) {
      var n = e.collections.sourceLoadHandlers,
        o = e.elements,
    ...
    function j(e) {
      ...
      o.className = "".concat(i, "nav"), n.appendChild(o), D(e, o), t.length > 1 && function (e, t) {
        var n = e.componentsServices,
          o = e.props.sources,
    ...
    function _(e) {
      ...
      this.runActionsForEvent = function (e) {
        var t, a, c;
        n.container.contains(n.slideSwipingHoverer) || n.container.appendChild(n.slideSwipingHoverer), t = n.container, a = s, (c = t.classList).contains(a) || c.add(a), o.swipedX = e.screenX - o.downScreenX, r(i.current, "zero"), void 0 !== i.previous && o.swipedX > 0 ? r(i.previous, "negative") : void 0 !== i.next && o.swipedX < 0 && r(i.next, "positive");
      };
    }
    function J(e) {
      var t = e.props.sources,
    ...
    function K(e) {
      ...
      this.runNoSwipeActions = function () {
        $(n.container, n.slideSwipingHoverer), i.isSourceDownEventTarget || t.closeLightbox(), i.isPointering = !1;
      }, this.runActions = function () {
        i.swipedX > 0 ? r.runPositiveSwipedXActions() : r.runNegativeSwipedXActions(), $(n.container, n.slideSwipingHoverer), n.container.classList.remove(s), i.isPointering = !1;
      };
    }
    function Q(e) {
      var t = e.resolve,
    ...
    function ee(e) {
      var t = e.core.eventsDispatcher,
        ...
        o = e.elements,
        r = e.props.sources;
      n.isInitialized = !0, n.scrollbarWidth = function () {
      ...
      }(e), Z(e), o.container = document.createElement("div"), o.container.className = "".concat(i, "container ").concat(a, " ").concat(g), function (e) {
        var t = e.elements;
    ...
    function te(e) {
      ...
      r.open = function () {
        ...
        h.current = o, p.isInitialized ? i.dispatch("onShow") : ee(e), u.updateStageIndexes(), c.displaySourcesWhichShouldBeDisplayed(), n.setSlideNumber(o + 1), document.body.appendChild(f.container), document.documentElement.classList.add(l), a.addRecompense(), s.attachListeners(), d.runActions(), t[h.current].zero(), i.dispatch("onOpen");
      };
    }
    function ne(e, t, n) {
      return (ne = oe() ? Reflect.construct.bind() : function (e, t, n) {
        var o = [null];
        o.push.apply(o, t);
    ...
    function ae() {
      for (var e = document.getElementsByTagName("a"), t = function (t) {
          ...
          var n = e[t].getAttribute("data-fslightbox"),
            o = e[t].hasAttribute("data-href") ? e[t].getAttribute("data-href") : e[t].getAttribute("href");
          ...
          for (var s = ["href", "data-fslightbox", "data-href", "data-type", "data-video-poster", "data-class", "data-custom-class"], a = e[t].attributes, c = fsLightboxInstances[n].props.customAttributes, l = 0; l < a.length; l++) if (-1 === s.indexOf(a[l].name) && "data-" === a[l].name.substr(0, 5)) {
            c[r] || (c[r] = {});
    ...
    window.FsLightbox = function () {
      ...
      }, this.fs = {}, te(this), this.open = function (t) {
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery-swiper', {
  slidesPerView: 2,
  spaceBetween: 40,
  loop: true,
  preloadImages: true,
...
const slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.comment_swiper', {
  slidesPerView: 1,
  spaceBetween: 500,
  loop: true,
  preloadImages: true,
